...
description: Manages parallel work streams in a git worktree by spawning sub-agents and consolidating results. Perfect for executing multiple tasks simultaneously.
tools:
  Glob: true
  Grep: true
  LS: true
