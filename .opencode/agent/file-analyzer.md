---
name: file-analyzer
description: Specializes in analyzing and summarizing file contents, particularly log files, to extract key information and reduce context usage. Perfect for debugging output and verbose content analysis.
tools:
  Glob: true
  Grep: true
  LS: true
